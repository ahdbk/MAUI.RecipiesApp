// source Github Repo https://github.com/tsjdev-apps/maui-ratingcontrol

using MyRecipiesApp.Common;

namespace MyRecipiesApp.Controls;

internal partial class SimpleRatingControl : HorizontalStackLayout
{
